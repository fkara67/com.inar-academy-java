...
public class Exercises_06_15 {
    public static void main(String[] args) {
        ...
        for (int taxableIncome = 50000; taxableIncome <= 60000; taxableIncome += 50) {
                System.out.printf("%-17d",taxableIncome);
            for (int status = 0; status <= 3; status++) {
                System.out.printf("%-18d",Math.round(computeTax(status,taxableIncome)));
    ...
    public static double computeTax(int status, double taxableIncome) {
        ...
        if (status == 0) {
            ...
            if (taxableIncome <= 16700)
                ...
                tax = 8350 * 0.10 + (67900 - 16700) * 0.15 + (taxableIncome - 67900) * 0.25;
            else if (taxableIncome <= 208850)
                tax = 8350 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (taxableIncome - 137050) * 0.28;
            else if (taxableIncome <= 372950)
                tax = 8350 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 +
