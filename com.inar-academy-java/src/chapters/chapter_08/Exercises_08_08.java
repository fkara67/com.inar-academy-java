...
public class Exercises_08_08 {
    /* 1- prompt the user to enter number of points
       2- prompt the user to enter the points(x,y)
       3- put the points to a two-dim array
       4- display all closest pairs of points with the same minimum distance
     */
