...
public class Exercises_08_34 {
    /* Geometry: rightmost lowest point
        1- prompt the user to enter the coordinates of six points
        2- find the rightmost lowest point in a set of points
        3- display the rightmost lowest point
     */
