...
import chapters.chapter_06.RandomCharacter_06_10;
...
public class Listing_07_04 {
    ...
    public static char[] createArray() {
        ...
        for (int i = 0; i < chars.length; i++) {
            chars[i] = RandomCharacter_06_10.getRandomLowerCaseLetter();
        }
        return chars;
    }
    ...
    public static int[] countLetters(char[] chars) {
        // Declare and create an array of 26 int for 26 letters in alphabet
